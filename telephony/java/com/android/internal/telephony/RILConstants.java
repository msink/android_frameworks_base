...
*/
    ...
    int RIL_REQUEST_SET_AUDIO_MODE = 110;
    int RIL_REQUEST_GET_AUDIO_MODE = 111;
    int RIL_REQUEST_SET_AUDIO_MODE_VOLUME = 112;
    int RIL_REQUEST_GET_AUDIO_MODE_VOLUME = 113;
