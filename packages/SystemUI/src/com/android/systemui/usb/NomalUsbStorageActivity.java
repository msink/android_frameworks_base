 ...
 */
public class NomalUsbStorageActivity extends Activity
        implements View.OnClickListener, OnCancelListener {
    private static final String TAG = "NomalUsbStorageActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HandlerThread thr = new HandlerThread("SystemUI NomalUsbStorageActivity");
        thr.start();
